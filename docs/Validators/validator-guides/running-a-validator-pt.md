...
> **Atenção!**
>
> Se você receber um erro ERR_CONNECTION_REFUSED, verifique se seu navegador não está tentando abrir o endereço http://127.0.0.1:5000. Este é um redirecionamento incorreto do near-cli executando em uma instância remota, e pode ser ignorado.
...
![# 7153 | Altura do bloco V/1 | 'V' (validador) ou '—' (nó regular)](</../../../../static/img/validators-1-.png)
...
Para saber mais sobre como os validadores são escolhidos, dê uma olhada nas [Perguntas Frequentes Sobre Staking](../validator-support/faq.md).
